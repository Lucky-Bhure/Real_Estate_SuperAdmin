  ...
  return (
    <div className='relative w-120 py-22 px-4 bg-white rounded-lg shadow-md z-4 flex flex-col justify-center items-center'>
        ...
        <form className='flex w-[80%] flex-col'>
            ...
            <button type='submit' className='w-80 mt-12 mx-auto bg-[#00A58E] text-white py-2 rounded-md justify-center items-center cursor-pointer font-[700]' onClick={() => navigate('/resetpassword')}>Reset Password</button>
        </form>
