        ...
        <div className="w-9/12 bg-white p-10 shadow-md rounded-2xl">
          ...
          <div className="mb-4 flex justify-between items-center">
            ...
            <div className="flex w-[46%] justify-between border p-1 rounded-lg border-[#00a58e]">
              <button className={`px-4 p-2 text-[12px] border border-[#00a58e] rounded-md ${isActive.daily ? 'bg-[#00a58e] text-white' : 'bg-transparent'}`} onClick={() => handleChart('daily')}>
                DAILY
              </button>
              <button className={`px-4 p-2 text-[12px] border border-[#00a58e] rounded-md ${isActive.weekly ? 'bg-[#00a58e] text-white' : 'bg-transparent'}`} onClick={() => handleChart('weekly')}>
                WEEKLY
              </button>
              <button className={`px-4 p-2 text-[12px] border border-[#00a58e] rounded-md ${isActive.monthly ? 'bg-[#00a58e] text-white' : 'bg-transparent'}`} onClick={() => handleChart('monthly')}>
                MONTHLY
              </button>
              <button className={`px-4 p-2 text-[12px] border border-[#00a58e] rounded-md ${isActive.yearly ? 'bg-[#00a58e] text-white' : 'bg-transparent'}`} onClick={() => handleChart('yearly')}>
                YEARLY
              </button>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-[70%] flex flex-col items-center mt-4">
              <div className="border border-[#00a58e] rounded-md w-full flex items-center px-4 py-2 bg-white">
                <input type="date" className="w-full text-xs text-gray-700 font-medium outline-none appearance-none text-center"></input>
              </div>
            </div>
