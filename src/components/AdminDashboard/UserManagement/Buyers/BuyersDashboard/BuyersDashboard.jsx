    ...
    <>
      ...
      <section className='w-full py-6 px-8 mt-10 bg-white rounded-xl'>
        <div className='w-full flex justify-between'>
          ...
          <p className='text-sm text-[#8B909A] font-[500] mr-4' onClick={() => navigate("/superadmin/usermanagement/buyers-recent-registered")}>View More</p>
        </div>

        <RecentRegisteredBuyers value={3} />
      </section> 
    </>
  )
}
